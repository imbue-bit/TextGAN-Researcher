...
class ViewCurrentGenerationTool(BaseTool):
    """查看当前生成内容工具"""
    name: str = "view_current_generation"
    description: str = "View the most recently generated research content. Input: None. Output: The full content string."

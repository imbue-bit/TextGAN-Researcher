...
class UpdateGoalStatusTool(BaseTool):
    """更新目标状态工具"""
    name: str = "update_goal_status"
    description: str = "Update the status of a specific decomposed goal. Input: JSON string with 'goal_id' and 'status' (e.g., 'completed', 'in_progress', 'pending'). Example input: '{{\"goal_id\": \"goal_1\", \"status\": \"completed\"}}'"
